...
export default class AdminEditPost extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ename: "",
  ...
  onUpdate = (e) => {
    ...
    const id = window.location.pathname.split("/admin-edit/")[1];
    //console.log(id);
    //console.log(params);
  ...
  componentDidMount() {
    console.log(window.location.pathname.split("/admin-edit/")[1]);
    const id = window.location.pathname.split("/admin-edit/")[1];
